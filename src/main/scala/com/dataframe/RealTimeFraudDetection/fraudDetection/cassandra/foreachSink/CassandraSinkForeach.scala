package com.dataframe.RealTimeFraudDetection.fraudDetection.cassandra.foreachSink

import com.dataframe.RealTimeFraudDetection.fraudDetection.creditcard.Enums
